...
#property indicator_chart_window // desenhado na mesma janela do gráfico
// #property indicator_separate_window // desenhado em outra janela separada
...
//--- indicator buffers mapping
   SetIndexBuffer(0,MediaBuffer,INDICATOR_DATA); // Definição do array MediaBuffer como buffer do indicador Media (plot-media = 1)
